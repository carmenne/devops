...
public class DevopsApplication implements CommandLineRunner {
    ...
    private String webmasterUserPassword;
    @Value("${webmaster.email}")
    private String webmasterUserEmail;
    ...
    public void run(String... args) throws Exception{
        ...
        User user = UserUtils.createBasicUser(webmasterUsername, webmasterUserEmail);
        user.setPassword(webmasterUserPassword);
